...
function PrimaryBtn({ t, children, onClick, disabled }) {
  return (
    <button
      ...
      style={{
        width: '100%',
        background: disabled ? t.s2 : t.accent,
...
// ─── Step 1: Name + Goal ─────────────────────────────────────────────
function Step1({ t, name, setName, goal, setGoal, onNext }) {
  const goals = [
  ...
  return (
    <div style={{ padding: '20px 20px 0', flex: 1, overflowY: 'auto', paddingBottom: 20 }}>
      ...
      <div style={{ marginBottom: 20 }}>
        <MonoLabel t={t}>What's your primary goal?</MonoLabel>
      ...
      <PrimaryBtn t={t} onClick={onNext} disabled={!name.trim() || !goal}>Continue</PrimaryBtn>
    </div>
  );
}
  ...
  return (
    <div style={{ padding: '20px 20px 0', flex: 1, overflowY: 'auto', paddingBottom: 20 }}>
      ...
      <div style={{
        ...
        color: t.fgMuted,
        marginBottom: 20,
      }}>Helps calibrate your programming intensity.</div>
  ...
  return (
    <div style={{ padding: '20px 20px 0', flex: 1, overflowY: 'auto', paddingBottom: 20 }}>
      ...
      <div style={{
        ...
        color: t.fgMuted,
        marginBottom: 24,
      }}>So SOMA can plan recovery and load.</div>
...
// ─── Step 4: Health baselines ─────────────────────────────────────────
function Step4({ t, weight, setWeight, height, setHeight, hrRest, setHrRest, onNext }) {
  ...
  return (
    <div style={{ padding: '20px 20px 0', flex: 1, overflowY: 'auto', paddingBottom: 20 }}>
      ...
      <div style={{
        ...
        color: t.fgMuted,
        marginBottom: 24,
      }}>Used to calibrate nutrition and recovery targets.</div>

      <div style={{ marginBottom: 20 }}>
        <MonoLabel t={t}>Body weight (kg)</MonoLabel>
        {numInput('75', weight, setWeight)}
      </div>

      <div style={{ marginBottom: 20 }}>
        <MonoLabel t={t}>Height (cm)</MonoLabel>
        {numInput('175', height, setHeight)}
      </div>
  ...
  return (
    <div style={{
      ...
      <div style={{ width: '100%', marginTop: 'auto', paddingBottom: 30 }}>
        <PrimaryBtn t={t} onClick={onEnter}>Enter SOMA →</PrimaryBtn>
      </div>
    </div>
  );
}
